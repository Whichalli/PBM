import 'package:pbm_app/presentation/pumping_screen/controller/pumping_controller.dart';
...
class PumpingScreen extends GetWidget<PumpingController> {
  const PumpingScreen({Key? key}) : super(key: key);
