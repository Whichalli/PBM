      ...
      child: Scaffold(
        ...
        appBar: CustomAppBar(
            ...
            title: AppbarSubtitle3(
                text: "lbl_team".tr, margin: getMargin(left: 20)),
            actions: [
              AppbarImage(
                  height: getSize(20),
                  width: getSize(20),
                                                                  ...
                                                                  child: Stack(
                                                                      ...
                                                                      children: [
                                                                        CustomImageView(
                                                                            onTap:
                                                                                () {
                                                                              Get.toNamed(AppRoutes.nurseProfileDetails, arguments: {
                                                                                'employeeId': data.value[index].id,
                                                                                'data': data.value[index].data()
                                                                              });
                                                                            },
                                                                            url:
                                                                                data.value[index]['photoUrl'],
                                                                        ...
                                                                        Align(
                                                                            ...
                                                                            child: Container(
                                                                                height: getSize(9),
                                                                                width: getSize(9),
                                                                                decoration: BoxDecoration(color: ColorConstant.greenA700, borderRadius: BorderRadius.circular(getHorizontalSize(4)), border: Border.all(color: ColorConstant.whiteA700, width: getHorizontalSize(1), strokeAlign: strokeAlignCenter))))
                                                                      ])),
                                                              Padding(
                                                                  padding:
                                                                      getPadding(
                                                                      ...
                                                                      children: [
                                                                        ...
                                                                        Row(
                                                                          children: [
                                                                            ...
                                                                            Text("${data.value[index].data()['profession'] ?? '___ ___ ___'}".tr.capitalize!,
                                                                                overflow: TextOverflow.ellipsis,
                                                                                textAlign: TextAlign.left,
                                                                        ...
                                                                        Row(
                                                                          children: [
                                                                            Container(
                                                                                margin: getMargin(right: 5, bottom: 2),
                                                                            ...
                                                                            SizedBox(
                                                                              ...
                                                                              child: Text("${data.value[index].data()['address'] ?? '___ ___ ___'}".tr.capitalize!, overflow: TextOverflow.ellipsis, maxLines: 1, softWrap: true, textAlign: TextAlign.left, style: AppStyle.txtOpenSansRomanSemiBold16Gray800.copyWith(fontSize: 12, color: Colors.black45)),
                                                                            ),
                                                                          ],
                                                                        ),
                                                                      ])),
                                                                  ...
                                                                  child: Column(
                                                                      ...
                                                                      children: [
                                                                        Row(
                                                                            ...
                                                                            children: [
                                                                              CustomImageView(svgPath: ImageConstant.imgStar, height: getSize(14), width: getSize(14), margin: getMargin(top: 2, bottom: 3)),
                                                                              Padding(padding: getPadding(left: 5), child: Text("lbl_4_0".tr, overflow: TextOverflow.ellipsis, textAlign: TextAlign.left, style: AppStyle.txtOpenSansRomanSemiBold14PinkA100))
                                                                            ]),
                                                                        Padding(
                                                                            padding:
                                                                                getPadding(top: 5),
                                                                            child: Text("lbl_12".tr, overflow: TextOverflow.ellipsis, textAlign: TextAlign.left, style: AppStyle.txtOpenSansRomanSemiBold10Gray600))
                                                                      ]))
                                                            ]),
                                                        Padding(
                                                            padding: getPadding(
                                                                  ...
                                                                  CustomIconButton(
                                                                      onTap:
                                                                        ...
                                                                        Get.toNamed(
                                                                            ...
                                                                            arguments: {
                                                                              'partnerId': data.value[index].id,
                                                                              'chatId': '${data.value[index].id}-${Authentication.getCurrentUserId()}',
                                                                              'account': 'parent',
                                                                              'partnerDetails': ChatItemModel(chatId: '${data.value[index].id}-${Authentication.getCurrentUserId()}', chatActive: true, employeeId: data.value[index].id, lastMessage: '', parentId: Authentication.getCurrentUserId(), accountType: 'employee', field: 'parent', unread: 0, time: DateTime.now()),
                                                                            });
                                                                      },
                                                                      height:
                                                                          48,
