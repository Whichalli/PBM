...
import 'package:pbm_app/presentation/upcoming_booking_three_screen/models/upcoming_booking_three_model.dart';
import 'package:flutter/material.dart';

/// A controller class for the UpcomingBookingThreeScreen.
///
/// This class manages the state of the UpcomingBookingThreeScreen, including the
/// current upcomingBookingThreeModelObj
class UpcomingBookingThreeController extends GetxController {
  ...
  Rx<UpcomingBookingThreeModel> upcomingBookingThreeModelObj =
      UpcomingBookingThreeModel().obs;
  ...
  void onClose() {
    ...
    childsdateofbirController.dispose();
    addressController.dispose();
    namethreeController.dispose();
    activitieschildController.dispose();
    genderController.dispose();
    timezoneController.dispose();
    pleasestatethreController.dispose();
    pleasestatethreController1.dispose();
    pleasestatethreController2.dispose();
  }
}
